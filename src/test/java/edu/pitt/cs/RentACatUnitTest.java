...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		// TODO: Fill in
		r = RentACat.createInstance(InstanceType.IMPL); // Adjust depending on test
	...
	public void testListCatsNumCats3() {
		...
		String result = r.listCats();
		assertEquals("ID 1. Jennyanydots" + newline +
					 "ID 2. Old Deuteronomy" + newline +
					 "ID 3. Mistoffelees" + newline, result);	
	}
	...
	public void testRentCatNumCats3() {
		...
		when(c2.getRented()).thenReturn(false); // Mock that c2 is not rented
	
		boolean result = r.rentCat(2);
		assertTrue(result); // Rent should succeed
	...
	public void testRentCatFailureNumCats3() {
		...
		when(c2.getRented()).thenReturn(true); // Mock that c2 is already rented
	
		boolean result = r.rentCat(2);
		assertFalse(result); // Rent should fail
	...
	public void testReturnFailureCatNumCats3() {
		...
		when(c2.getRented()).thenReturn(true); // Mock that c2 is rented
